...
new #[Layout('layouts.guest')] class extends Component
{
    ...
    public string $role = 'candidate'; // Default role
    ...
    public function register(): void
    {
        $validated = $this->validate([
            ...
            'role' => ['required', 'string', 'in:candidate,HR admin'],
        ]);
        ...
        if ($user->role === 'candidate') {
            $this->redirect(route('candidate.overview', absolute: false), navigate: true);
        } else {
            $this->redirect(route('hr.overview', absolute: false), navigate: true);
        }
    }
}; ?>

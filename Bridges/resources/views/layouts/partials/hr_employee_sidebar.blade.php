<div class="sidebar-header">
  ...
  <nav class="sidebar-nav">
    <a href="{{ route('hr_employee.overview') }}" class="nav-item {{ request()->routeIs('hr_employee.overview') ? 'active' : '' }}">
    ...
    <a href="{{ route('hr_employee.job-requisitions') }}" class="nav-item {{ request()->routeIs('hr_employee.job-requisitions') ? 'active' : '' }}">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
      <span class="nav-label">Job requisition</span>
    </a>
    <a href="{{ route('hr_employee.interviews') }}" class="nav-item {{ request()->routeIs('hr_employee.interviews') ? 'active' : '' }}">
    ...
    <a href="{{ route('hr_employee.feedback') }}" class="nav-item {{ request()->routeIs('hr_employee.feedback') ? 'active' : '' }}">

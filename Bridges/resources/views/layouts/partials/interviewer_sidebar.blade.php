<div class="sidebar-header">
    ...
    <!-- SIDEBAR TOGGLE: Managed by sidebar.js to shrink the sidebar width -->
  ...
  <nav class="sidebar-nav">
    <a href="{{ route('interviewer.overview') }}" class="nav-item {{ request()->routeIs('interviewer.overview') ? 'active' : '' }}">
    ...
    <a href="{{ route('interviewer.interviews') }}" class="nav-item {{ request()->routeIs('interviewer.interviews') ? 'active' : '' }}">
    ...
    <a href="{{ route('interviewer.feedback') }}" class="nav-item {{ request()->routeIs('interviewer.feedback') ? 'active' : '' }}">
  ...
  <div class="sidebar-footer">
    <a href="#" class="nav-item">
      <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 014 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83 0 2 2 0 010-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 010-2.83 2 2 0 012.83 0l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 0 2 2 0 010 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z"/></svg>
